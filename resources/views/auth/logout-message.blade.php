...
<body class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gray-100">
    ...
    <!-- FONDO: LOGIN REAL (borroso) -->
    <div class="fixed inset-0 overflow-hidden pointer-events-none z-0">
        <div class="blur-background h-full w-full scale-105">
            @include('login') <!-- TU PÁGINA DE LOGIN REAL -->
        </div>
    </div>
    ...
    <!-- CARD DE DESPEDIDA (encima de todo) -->
    <div class="relative z-20 fade-slide glass-card p-10 rounded-3xl text-center max-w-md w-full mx-6 shadow-2xl">
        ...
        <h1 class="text-3xl font-bold text-white mb-2">
            ¡Hasta pronto, <span class="text-emerald-300">{{ session('user_name') }}</span>!
        </h1>
        <p class="text-gray-200 mb-8">Sesión cerrada correctamente.</p>
    ...
    <!-- SCRIPT: Animación de salida + redirección -->
    <script>
        setTimeout(() => {
